...
declare module "test-suite-methods/make-after-each" {
    var _default: (suman: any, zuite: any) => Function;
    export = _default;
}
...
declare module "test-suite-methods/make-describe" {
    var _default: (suman: any, gracefulExit: Function, TestSuiteMaker: any, zuite: any, notifyParentThatChildIsComplete: Function) => Function;
    export = _default;
}
